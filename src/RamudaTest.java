...
public class RamudaTest {
	...
	public static void testMethod1(List<User> users) {
		List<Integer> result = users.stream() // ここでリストusersからstreamオブジェクトを取得
				.map( // 写像開始
	...
	public static void testMethod2(List<User> users) {
